...
| etcd.persistence | object | `{"accessModes":["ReadWriteOnce"],"annotations":{},"enabled":true,"selector":{},"size":"8Gi","storageClass":"ebs-sc"}` | enable persistence using persistent volume claims |
...
| etcd.persistence.storageClass | string | `"ebs-sc"` | custom persistence storageclass setting |
