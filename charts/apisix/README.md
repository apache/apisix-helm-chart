...
| `apisix.topologySpreadConstraints`                | Topology constraints for the apisix pod placement. See [Pod Topology Spread Constraints](https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/) for more detail.                                                                                                                                                                                                    | `[]` |
