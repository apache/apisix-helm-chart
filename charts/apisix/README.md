...
| gateway.http | object | `{"containerPort":9080,"enabled":true,"servicePort":80,"additionalContainerPorts":[]}` | Apache APISIX service settings for http |
...
| gateway.tls | object | `{"certCAFilename":"","containerPort":9443,"additionalContainerPorts":[],"enabled":false,"existingCASecret":"","http2":{"enabled":true},"servicePort":443,"sslProtocols":"TLSv1.2 TLSv1.3"}` | Apache APISIX service settings for tls |
