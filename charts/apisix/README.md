...
| `apisix.enableCustomizedDebugConfig`              | Enable full customized `debug.yaml`                                                                                                                                                                                                                                                                                          | `false`                                                |
| `apisix.customizedDebugConfig`                    | If `apisix.enableCustomizedDebugConfig` is true, full customized `debug.yaml`. Please note that other settings about APISIX debug config will be ignored                                                                                                                                                                     | `{}`                                                   |
| `apisix.debug.enabled`                            | Enable basic debugging [Debug Mode](https://apisix.apache.org/docs/apisix/2.15/architecture-design/debug-mode/)                                                                                                                                                                                                              | `false`                                                |
